    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            if int(index) == int(data["total"]) - 2:
                ...
                buttons.append(
                    [InlineKeyboardButton("⏪ BACK", callback_data=f"back_{int(index)+1}_{keyword}"),InlineKeyboardButton(f"🗓 Pages {int(index)+2}/{data['total']}", callback_data="pages")]
                ) 
                ...
                buttons.append(
                    [InlineKeyboardButton("⏪ BACK", callback_data=f"back_{int(index)+1}_{keyword}"),InlineKeyboardButton(f"🗓 Pages {int(index)+2}/{data['total']}", callback_data="pages"),InlineKeyboardButton("NEXT ⏩", callback_data=f"next_{int(index)+1}_{keyword}")]
                )
            ...
            if int(index) == 1:
                ...
                buttons.append(
                    [InlineKeyboardButton("NEXT ⏩", callback_data=f"next_{int(index)-1}_{keyword}"),InlineKeyboardButton(f"🗓 Pages {int(index)}/{data['total']}", callback_data="pages")]
                )
